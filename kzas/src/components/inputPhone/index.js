...
export function InputPhone({ phone, onChange }) {
    ...
    return (
        <div className="input dropdown">
            ...
            <NumberPhone type="text" error={error} onBlur={(event) => { MascaraDeTelefone(event.target.value)}} value={phone} onChange={(event) => { onChange(event.target.value) }}
